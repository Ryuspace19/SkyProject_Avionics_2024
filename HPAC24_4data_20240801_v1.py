...
# 数値部分のラベルを作成して配置
label_speed_value = tk.Label(root, text="0.0", font=('Helvetica', 130))
label_speed_value.place(x=200, y=80)

label_rpm_value = tk.Label(root, text="0", font=('Helvetica', 130))
label_rpm_value.place(x=870, y=80)

label_altitude_value = tk.Label(root, text="0", font=('Helvetica', 130))
label_altitude_value.place(x=200, y=430)

# 単位のラベルを作成して配置
label_speed_unit = tk.Label(root, text="m/s", font=('Helvetica', 40))
label_speed_unit.place(x=550, y=275)

label_rpm_unit = tk.Label(root, text="rpm", font=('Helvetica', 40))
label_rpm_unit.place(x=1170, y=275)

label_altitude_unit = tk.Label(root, text="cm", font=('Helvetica', 40))
label_altitude_unit.place(x=550, y=625)
